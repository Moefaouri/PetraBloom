...
const products: Product[] = [
  {
    ...
    title: "كيلو عسل جبلي",
    description:
      "كيلو واحد من العسل الطبيعي الأصلي، قطفة ربيع 2025 مع تغليف مميز",
  ...
  },
  {
    ...
    description:
      "نصف كيلو من العسل الطبيعي الأصلي، قطفة ربيع 2025 مع تغليف مميز",
  ...
  },
  {
    ...
    title: "حبوب لقاح",
    description:
      "(250 غم) غنية بالفيتامينات، البروتينات، ومضادات الأكسدة اللي بتقوّي المناعة، تزيد النشاط، وبتدعم صحة الهضم والبشرة",
              ...
              <div className="card-body">
                ...
                <div
                  className={`mt-3 text-center ${
                    total > 15 ? "text-success" : "text-muted"
                  }`}
                >
                  {total >= 15 ? (
                ...
                >
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    style={{ fill: "#fff", height: "32px", width: "32px" }}
                  >
